...
public class ATest {
   ...
   @Test
   public void atest(){
        try (FileWriter fileWriter = new FileWriter("D:/wer/a.txt")){
    ...
    public void testHex(){
        byte key[] = new byte[0];
        try {
            key = "kymis_authorityX".getBytes("utf-8");
    ...
    public static void main(String[] args) {
       // char[] a = new String("").toCharArray();
        try {
            // 密钥必须是16的倍数
            //byte key[] = "1234567890ABCDEF1234567890ABCDEf".getBytes("utf-8");
            byte key[] = "kymis_authorityX".getBytes("utf-8");
            String src = "werty7890";
            System.out.println("密钥:"+byteToHexString(key));
            System.out.println("原字符串:"+src);
